...
<?php if ( $meta_value ) : ?>
<div <?php echo get_block_wrapper_attributes(['class' => 'directorist-gutenberg-listing-card-block ' . implode( ' ', $wrapper_classes )]); ?> class="directorist-gutenberg-listing-card-element directorist-gutenberg-listing-card-element-custom-time">
    <div class="directorist-gutenberg-listing-card-element-content">
        ...
        <div class="directorist-gutenberg-listing-card-element-details">
            <span class="directorist-gutenberg-listing-card-element-value">
                <?php echo function_exists( 'directorist_format_time' ) ? directorist_format_time( $meta_value ) : $meta_value; ?>
            </span>
        </div>
    </div>
</div>
